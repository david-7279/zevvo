...
const SupportAside: React.FC<Props> = ({ items, activeId, onItemClick }) => {
  return (
    <aside className="w-full lg:w-80 shrink-0">
      <div className="lg:sticky lg:top-6">
        ...
        <div className="mb-6">
          <h2 className="text-sm font-semibold text-muted-foreground tracking-wide mb-4 uppercase">Opções de Suporte</h2>
