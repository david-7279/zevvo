...
interface FeatureHeaderCardComponentProps {
  data?: HeaderCardData[]
}

const FeatureHeaderCardComponent = ({ data = OverviewHeaderCard }: FeatureHeaderCardComponentProps) => {
  return (
    <>
      {data.map((data, index) => {
...
export default FeatureHeaderCardComponent